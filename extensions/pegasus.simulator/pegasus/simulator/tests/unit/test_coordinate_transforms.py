...
class TestCoordinateTransforms:
    ...
    def test_flu_to_ned_inertial_rotation_matrix(self, rot_NWU_to_NED):
        ...
        actual_matrix = rot_NWU_to_NED.as_matrix()
        np.testing.assert_array_almost_equal(actual_matrix, expected_matrix)

    def test_flu_to_frd_body_rotation_matrix(self, rot_FLU_to_FRD):
        ...
        actual_matrix = rot_FLU_to_FRD.as_matrix()
        np.testing.assert_array_almost_equal(actual_matrix, expected_matrix)
    ...
    def test_angular_velocity_flu_to_frd(self, rot_FLU_to_FRD, test_case):
        ...
        actual_frd = rot_FLU_to_FRD.apply(flu_ang_vel)
...
class TestYawOffsetFix:
    ...
    def test_attitude_transformation_yaw(self, rot_NWU_to_NED,
                                        rot_FLU_to_FRD, quat_data):
        ...
        attitude_frd_ned = (rot_NWU_to_NED *
                           attitude_flu *
                           rot_FLU_to_FRD)
    ...
    def test_identity_quaternion_gives_zero_yaw(self, rot_NWU_to_NED,
                                               rot_FLU_to_FRD):
        ...
        # Transform
        result = rot_NWU_to_NED * identity * rot_FLU_to_FRD
...
class TestVelocityTransformations:
    ...
    def test_velocity_transformations_batch(self, rot_NWU_to_NED,
                                           test_velocities):
        ...
        for test_case in test_velocities:
            ...
            actual_ned = rot_NWU_to_NED.apply(flu_vel)
...
class TestCompleteTransformPipeline:
    ...
    def test_full_state_transformation(self, rot_NWU_to_NED,
                                      rot_FLU_to_FRD):
        ...
        angular_velocity_frd = rot_FLU_to_FRD.apply(angular_velocity_flu)
